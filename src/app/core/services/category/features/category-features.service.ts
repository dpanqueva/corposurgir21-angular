...
export class CategoryFeaturesService {
  ...
  getFeaturesById(featureId: string): Observable<CategoryFeature> {
    return this.http
      .get<CategoryFeature>(
        this.urlEndPoint.concat('-detail').concat('/').concat(featureId),
  ...
  createFeatures(feature: CategoryFeature): Observable<CategoryFeature> {
    return this.http
      .post<CategoryFeature>(this.urlEndPoint, feature, {
        headers: this.addAuthorizationHeader(),
      })
      .pipe(catchError((e) => this.errorsApiGenerate(e)));
  }
  ...
  updateFeatures(
    ...
    featureId: number
  ): Observable<CategoryFeature> {
    return this.http
      .put<CategoryFeature>(
        this.urlEndPoint.concat('/').concat(featureId.toString()),
        feature,
        { headers: this.addAuthorizationHeader() }
      )
      .pipe(catchError((e) => this.errorsApiGenerate(e)));
  ...
  deleteCategory(feature): Observable<CategoryFeature> {
    return this.http
      .delete<CategoryFeature>(
        this.urlEndPoint.concat('/').concat(feature.detalle_id.toString()),
        { headers: this.addAuthorizationHeader() }
      )
      .pipe(catchError((e) => this.errorsApiGenerate(e)));
  }
